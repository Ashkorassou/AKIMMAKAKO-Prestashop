...
class __TwigTemplate_cc271c486265114579bccff7537de8a3abcb086d9505932401bdd534d86f425b extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 28
        if ((0 === twig_compare((isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 28, $this->source); })()), "configure"))) {
            // line 29
            echo "
    <a class=\"";
            // line 30
...
{% endif %}
", "@PrestaShop/Admin/Module/Includes/action_button.html.twig", "C:\\wamp64\\www\\prestashop2\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Module\\Includes\\action_button.html.twig");
    }
}
