...
class __TwigTemplate_9c582b08ffe768366e80da11e477c1f516866621ee7539795948f127b8260aa2 extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 35, $this->source); })()), "request", [], "any", false, false, false, 35), "query", [], "any", false, false, false, 35), "get", [0 => "id_cms_category"], "method", false, false, false, 35)]), "desc" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Add new page", [], "Admin.Design.Help"), "icon" => "add_circle_outline"]];
  ...
  ";
    ...
    public function block_cms_category_grid($context, array $blocks = [])
    {
        ...
        // line 51
        echo "    ";
        $this->loadTemplate("@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", 51, "1454929085")->display(twig_array_merge($context, ["grid" => (isset($context["cmsCategoryGrid"]) || array_key_exists("cmsCategoryGrid", $context) ? $context["cmsCategoryGrid"] : (function () { throw new RuntimeError('Variable "cmsCategoryGrid" does not exist.', 51, $this->source); })())]));
        // line 58
        echo "  ";
...
{% endblock %}
", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "C:\\wamp64\\www\\prestashop2\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Improve\\Design\\Cms\\index.html.twig");
    }
}


/* @PrestaShop/Admin/Improve/Design/Cms/index.html.twig */
class __TwigTemplate_9c582b08ffe768366e80da11e477c1f516866621ee7539795948f127b8260aa2___1454929085 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_grid_panel_footer($context, array $blocks = [])
    {
        ...
        // line 53
        echo "        ";
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 53, $this->source); })()), "request", [], "any", false, false, false, 53), "query", [], "any", false, false, false, 53), "get", [0 => "id_cms_category"], "method", false, false, false, 53) && (0 !== twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 53, $this->source); })()), "request", [], "any", false, false, false, 53), "query", [], "any", false, false, false, 53), "get", [0 => "id_cms_category"], "method", false, false, false, 53), twig_get_attribute($this->env, $this->source, (isset($context["cmsPageView"]) || array_key_exists("cmsPageView", $context) ? $context["cmsPageView"] : (function () { throw new RuntimeError('Variable "cmsPageView" does not exist.', 53, $this->source); })()), "root_category_id", [], "any", false, false, false, 53))))) {
            // line 54
            echo "          ";
